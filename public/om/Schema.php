...
<div class="container">
      ...
      <div class="panel-body">
          <?php
            ...
            if($_SESSION['class_id'] == 1 && ($xplode[0] === "WUK14") && ($xplode[1] === "Schema.pdf"))
            {
                echo "<a href='../upload/$directory[$i]' target=\"_blank\"> Visa </a>";
                
            }
            if($_SESSION['class_id'] == 2 && ($xplode[0] === "PTK14") && ($xplode[1] === "Schema.pdf"))
            {
                echo "<a href='../upload/$directory[$i]' target=\"_blank\"> Visa </a>";
            }
            if($_SESSION['class_id'] == 3 && ($xplode[0] === "COB14") && ($xplode[1] === "Schema.pdf"))
            {
                echo "<a href='../upload/$directory[$i]' target=\"_blank\"> Visa </a>";
            }
            if($_SESSION['class_id'] == 4 && ($xplode[0] === "PRL14") && ($xplode[1] === "Schema.pdf"))
            {
                echo "<a href='../upload/$directory[$i]' target=\"_blank\"> Visa </a>";
            }
            }
